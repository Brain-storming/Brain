...
public class ZfdmGame extends BaseActivity {

	TextView textView[] = new TextView[36];
	String returnValue[] = new String[36];
	TextView yonghu1View, yonghu2View, jishu1View, jishu2View;
	String touchChengyu = "";
	Button shijianButton;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 添加布局
		setContentView(R.layout.zfdm_game);
		...
		Communication.instance.getChengYu(9);

		shijianButton = (Button) findViewById(R.id.zfdm_shijian);
		...
		yonghu1View = (TextView) findViewById(R.id.zfdm_yonghu1);
		yonghu2View = (TextView) findViewById(R.id.zfdm_yonghu2);
		jishu1View = (TextView) findViewById(R.id.zfdm_jishu1);
		jishu2View = (TextView) findViewById(R.id.zfdm_jishu2);

		yonghu1View.setText(Constant.userName);
		System.out.println("tm的用户名是：：：" + Constant.userName);
